...
#  Introduction
   ...
   models. These guidelines can be used independent of the IETF publication
   stream or even by other organizations.
...
in the "ns" registry within the "IETF XML Registry" group MUST be
...
###  Guidance for Writing the IANA Considerations for RFCs Defining IANA-Maintained Modules {#sec-iana-mm}
   ...
   *  Details about the required actions (e.g., add a new "identity" or
      ...
      begins with a number, it is RECOMMENDED to spell out (i.e., write in full) the number when used as an identifier. IANA should be provided with instructions to perform such task. For example, authors of a module with such identifiers have to indicate whether:
...
The following registration in the "ns" registry of the "IETF XML
